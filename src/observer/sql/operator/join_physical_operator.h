 ...
 * @ingroup PhysicalOperator
 */
class InnerNestedLoopJoinPhysicalOperator : public PhysicalOperator
{
public:
  InnerNestedLoopJoinPhysicalOperator(std::unique_ptr<Expression> expression);
  virtual ~InnerNestedLoopJoinPhysicalOperator() = default;

  PhysicalOperatorType type() const override { return PhysicalOperatorType::INNER_NESTED_LOOP_JOIN; }
